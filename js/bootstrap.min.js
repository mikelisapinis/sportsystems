...
jQuery(document).ready(function () {
	...
	// ADD EVENTS TO SOCIAL LINKS
	var facebookLink = jQuery("ss.heateorSssFacebookSvg");
	var draugiemLink = jQuery("ss.heateorSssDraugiemSvg");
	var vkLink = jQuery("ss.heateorSssVkontakteSvg");
	var twitterLink = jQuery("ss.heateorSssTwitterSvg");
	var whatsappLink = jQuery("ss.heateorSssWhatsappSvg");
	var messengerLink = jQuery("ss.heateorSssFacebookMessengerSvg");

	facebookLink.attr("onClick", "ga('send', 'event', 'share', 'click', 'Facebook', '0')");
	draugiemLink.attr("onClick", "ga('send', 'event', 'share', 'click', 'Draugiem', '0')");
	vkLink.attr("onClick", "ga('send', 'event', 'share', 'click', 'Vkontakte', '0')");
	twitterLink.attr("onClick", "ga('send', 'event', 'share', 'click', 'Twitter', '0')");
	whatsappLink.attr("onClick", "ga('send', 'event', 'share', 'click', 'Whatsapp', '0')");
	messengerLink.attr("onClick", "ga('send', 'event', 'share', 'click', 'Messenger', '0')");


	// ADD EVENTS TO METASLIDER
	var metasSlides = jQuery(".metaslider .nivo-imageLink");

	jQuery.each(metasSlides, function () {
		var label = jQuery(this).find("img").attr("title");
		jQuery(this).attr("onClick", "ga('send', 'event', 'promotion click', 'click', '" + label + "', '0')");
	});


	// ADD EVENTS TO "ADD TO CART" BUTTONS 
	var homeProduct = jQuery(".home li.product");
	var categoryProduct = jQuery(".archive.tax-product_cat li.product");
	var singleProduct = jQuery(".single-product div.product");

	// HOME
	jQuery.each(homeProduct, function () {
		var productName = jQuery(this).find(".woocommerce-loop-product__title").html();

		if (jQuery(this).hasClass("sale")) {
			var productValue = jQuery(this).find("ins .amount").html();
		} else {
			var productValue = jQuery(this).find(".price .amount").html();
		}

		var addToCartButton = jQuery(this).find(".add_to_cart_button");

		// REMOVE THE SPAN WITH EURO SIGN
		if (typeof productValue !== 'undefined') {
			var productValue = productValue.replace('<span class="woocommerce-Price-currencySymbol">€</span>', '');
			var productValue = Math.floor(productValue);
		}

		addToCartButton.attr("onClick", "ga('send', 'event', 'Add to cart (Home)', 'click', '" + productName + "', '" + productValue + "')");
	});

	// CATEGORY PAGES
	jQuery.each(categoryProduct, function () {
		var productName = jQuery(this).find(".woocommerce-loop-product__title").html();
		...
		if (typeof productValue !== 'undefined') {
			var productValue = productValue.replace('<span class="woocommerce-Price-currencySymbol">€</span>', '');
			var productValue = Math.floor(productValue);
			addToCartButton.attr("onClick", "ga('send', 'event', 'Add to cart (Category page)', 'click', '" + productName + " | " + url + "', '" + productValue + "')");
		}

	});

	// ADD BOOTSTRAP CLASSES TO CATEGORY PAGES
	jQuery("li.product-category").addClass("col-12");
	jQuery("li.product-category img").not(".attachment-shop_catalog").addClass("float-left");
	jQuery("li.product-category").parent("ul").addClass("row");
	jQuery("li.product-category a:first-child").addClass("clearfix");

	// ADD LINK TO CATEGORY BUTTON
	var categoryButton = jQuery(".product-category .btn-primary");

	jQuery.each(categoryButton, function () {

		var categoryLink = jQuery(this).siblings("a.clearfix").attr("href");
		var categoryContainer = jQuery(this).siblings("a.clearfix");
		jQuery(this).attr("href", categoryLink).appendTo(categoryContainer);

	});


	// SINGLE PRODUCT PAGES
	jQuery.each(singleProduct, function () {
		var productName = jQuery(this).find("h1.product_title").html();
		...
		var addToCartButton = jQuery(this).find(".single_add_to_cart_button");
		...
		if (typeof addToCartButton !== 'undefined') {
			addToCartButton.attr("onClick", "ga('send', 'event', 'Add to cart (Single product page)', 'click', '" + productName + "', '" + productValue + "')");
		}
	});
	...
	jQuery(".show-menu.ion-android-menu").bind("click", function () {
		jQuery(this).toggleClass("ion-android-menu").addClass("ion-android-close");

	});

	jQuery(".show-menu.ion-android-close, .close-menu").bind("click", function () {
		jQuery(".show-menu.ion-android-close").toggleClass("ion-android-close").addClass("ion-android-menu");
		jQuery("#sidebar").toggleClass("show");
		jQuery("html, body").animate({ scrollTop: 0 }, "slow");
	});


	// ADD BOOTSTRAP CLASSES TO PRODUCTS IN CATALOG
	jQuery("li.product").not(".product-category").addClass("col-sm-6 col-md-4 col-lg-3");


	// ADD ICONS TO METASLIDER AND CAROUSEL
	jQuery(".nivo-prevNav").addClass("ion-chevron-left").html("");
	jQuery(".nivo-nextNav").addClass("ion-chevron-right").html("");
	jQuery(".carousel-control-prev-icon").addClass("ion-chevron-left");
	jQuery(".carousel-control-next-icon").addClass("ion-chevron-right");


	// ADD BOOTSTRAP TO LANGUAGE MENU
	jQuery("#language-menu .dropdown-menu a").addClass("dropdown-item");
	jQuery("#mobile-menu .dropdown-menu a").addClass("dropdown-item");
